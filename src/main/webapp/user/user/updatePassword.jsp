...
<html>
    ...
    $(document).ready(function(){
       ...
       return;
        ...
        $.ajax({type: "post", url: "${pageContext.request.contextPath}/user/user/updatePassword.action", dataType: "json", data:{"password":password,"oldPassword":oldPassword}, success: function (data) {
        alert(data.msg);  
       // alert("trtrtt");
        }
        });
